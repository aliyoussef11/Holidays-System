...
<div class="container" style ="margin-top: 30px;">
  <div class="row" style="text-align:center; width: 500px; margin-left:270px;">
    <a href="/request-a-holiday-non-academic" class="btn btn-success">ADD Holiday</a>
    <a href="/edit-a-holiday-non-academic" class="btn btn-primary">Edit Holidays</a>
    <a href="/delete-a-holiday-non-academic" class="btn btn-danger">Delete Holidays</a>
...
Your Holiday on <?php echo $one_notification->date;?> <?php echo $one_notification->response;?>
 ...
 <a href="<?php echo "Hide/".$one_notification->name."/".$one_notification->role
