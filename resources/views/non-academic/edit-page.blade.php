...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li><a href="/non-academic">Non Academic Page</a></li>
    </ul>
    <ul class="nav navbar-nav">
...
<table class="table table-striped table-bordered table-hover">
    <thead>
      ...
      <td><a href="<?php echo "/edit-non-academic-holiday/".$OneHoliday -> name."/".$OneHoliday -> role."/".$OneHoliday -> title."/".$OneHoliday -> date; ?> " 
      onclick="confirm ('Are you sure you want edit this Holiday?')" class="btn btn-success">Edit</a></td>
      </tr>
