    ...
    <div class="container">
        <nav aria-label="breadcrumb" style="width:30%; margin-left:210px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Manage Academic Holidays</li>
            </ol>
        </nav>
                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <form method="POST" action="/admin/manage-academic-holidays">
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <input type="text" class="form-control" value="Academic" name="Role" readonly>
                                </div>
                                <div class="form-group">
